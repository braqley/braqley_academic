...
from posts.models import Aj101Fall19Post, Post, Ps324Fall19Post
...
class Ps324Fall2019(TemplateView):
    ...
    def intro_posts(self):
        return Ps324Fall19Post.objects.filter(module="Intro")

    def mod1_posts(self):
        return Ps324Fall19Post.objects.filter(module="1")

    def mod2_posts(self):
        return Ps324Fall19Post.objects.filter(module="2")

    def mod3_posts(self):
        return Ps324Fall19Post.objects.filter(module="3")

    def mod4_posts(self):
        return Ps324Fall19Post.objects.filter(module="4")

    def mod5_posts(self):
        return Ps324Fall19Post.objects.filter(module="5")

    def mod6_posts(self):
        return Ps324Fall19Post.objects.filter(module="6")

    def mod7_posts(self):
        return Ps324Fall19Post.objects.filter(module="7")
